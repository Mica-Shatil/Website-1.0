    ...
    <div className="myweb__about section_margin" id="about"> {/* instead of gpt3__whatgpt3 section__margin" id="wgpt3 */}
      ...
      <div className="myweb__about-feature">
        <p>I am a studying computer science at the University of Waterloo and business at Wilfred Laurier University. I chose this double degree program because
            I love how both fields combine logic with creativity. On top of that, I just love a good challenge! I enjoy exercises in problem solving, especially when the
            problem is impacting others. Furthermore, I am a creative individual and a fast learner. Continuous growth through learning is something I am looking to be
