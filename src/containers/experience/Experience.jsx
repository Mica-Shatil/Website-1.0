...
const Experience = () => {
  return (
    <div className="myweb__experience" section_margin id="experience">
      ...
      <div className="myweb__experience-container row g-4">
        ...
        <div className="col-12 col-md-6">
          <Role
            ...
            tools="Microsoft Office 365 | Google Suit"
            image={dc180_logo}
            img_alt="temp"
            start_date="01.2021"
            end_date="09.2021"
        ...
        <div className="col-12 col-md-6">
          <Role
            ...
            tools="Python-(Pandas, Numpy) | Microsoft Excel | Clinic Master | Sage50"
            image={neuphysio_logo}
            img_alt="temp"
            start_date="05.2020"
            end_date="06.2020"
          />
        ...
        <div className="col-12 col-md-6">
          <Role
            company="United Way"
            title="Canada Life Youth United Advisory Council Member"
        ...
        <div className="col-12 col-md-6">
          <Role
            ...
            title="Company VP of Marketing and Sales"
